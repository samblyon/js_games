...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = __webpack_require__(169);
	
	document.addEventListener("DOMContentLoaded", function () {
	  ReactDOM.render(React.createElement(Game, null), document.getElementById('minesweeper'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Minesweeper = __webpack_require__(168);
	...
	var Game = React.createClass({
	  ...
	  updateGame: function updateGame(tile, flag) {
	    if (flag) {
	      tile.toggleFlag();
	    } else {
	      tile.explore();
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'h1',
	        null,
	        'Welcome to Minesweeper! Come play. It is free forever.'
	      ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Board = React.createClass({
	  ...
	  render: function render() {
	    ...
	    board = board.map(function (row, rowIdx) {
	      return React.createElement(
	        'div',
	        { key: rowIdx },
	        row.map(function (tile, tileIdx) {
	          return React.createElement(Tile, { key: tileIdx,
	            tile: tile,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tile = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      "div",
	      { className: appearance, onClick: this.handleClick },
	      content
	    );
	  }
	});
